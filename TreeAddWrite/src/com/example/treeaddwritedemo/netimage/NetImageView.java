package com.example.treeaddwritedemo.netimage;
...
public class NetImageView extends ImageView {
	...
	public Bitmap getBitmap(String url) {
		Bitmap btp = new NetImage(getContext(), url).getBitmap();
		return btp;
	}
	...
	public void setImageUrl(String url, final int fallbackResource, final int loadingResource,
			NetImageTask.OnCompleteListener completeListener) {
	...
	public void setImage(final Image image, final Integer fallbackResource, final Integer loadingResource,
			final NetImageTask.OnCompleteListener completeListener) {
